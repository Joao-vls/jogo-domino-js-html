...
bot3 = [];
let pobj = [];
var v11 = 6, v22 = 6, s = 0, qle = 0, qld = 0, led = 43, ldd = 49, tole = 50, told = 50, sese = 0;
...
function jogblock() {
  ...
  for (var i = 0; i < bot1.length; i++) {
    if (v11 == bot1[i].val || v22 == bot1[i].val2 || v11 == bot1[i].val2 || v22 == bot1[i].val1) {
      co = 1;
      break;
    }
  } if (co != 1) {
